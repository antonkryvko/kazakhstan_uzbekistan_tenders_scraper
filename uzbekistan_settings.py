...
SELECT_LOT_DESCRIPTION = 'strong'
SELECT_LOT_DESCRIPTION_SIBLING = 'Подробное описание:'
SELECT_LOT_NUMBER = 'div.full_block:first-of-type table tr > td:first-child'
SELECT_LOT_MEASUREMENT = 'div.full_block:first-of-type table tr > td:nth-of-type(2)'
SELECT_LOT_START_PRICE_DETAILED = 'div.full_block:first-of-type table tr > td:nth-of-type(3)'
SELECT_LOT_TOTAL_START_PRICE = 'div.full_block:first-of-type table tr > td:nth-of-type(4)'
